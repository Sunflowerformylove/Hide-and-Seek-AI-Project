...
def unobservable_cells(maze: list[list[int]], seeker_pos: tuple[int,int], vision_range: int, map_dimension: tuple[int, int]) -> list[tuple[int,int]]:
    ...
    # horizontal vision, blocked in Hanoi tower shape
    unobservable = []
    ...
    fives = [(seeker_pos[0] - 2, seeker_pos[1] - 1),
            (seeker_pos[0] - 2, seeker_pos[1] + 1),
            (seeker_pos[0] + 2, seeker_pos[1] - 1),
            (seeker_pos[0] + 2, seeker_pos[1] + 1) 
            ]
    for seven in sevens:
...
#     unobservable = []
#     # vertical, divided by top and bottom
#     for i in range(seeker_pos[0] - vision_range, seeker_pos[0]): # top
#         if i >= 0 and i < map_dimension[0] and maze[i][seeker_pos[1]] == 1:
#             # shape as Hanoi tower
...
# vision = vision_logic(maze, (0,5), 3, (8,11))
# for cell in vision:
